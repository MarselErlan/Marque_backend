...
from .routers.order_router import router as order_router  # NEW: Order creation and management
...
app.include_router(order_router, prefix="/api/v1")  # Order creation and management
